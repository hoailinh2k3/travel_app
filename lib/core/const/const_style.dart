...
extension ExtendedTextStyle on TextStyle {
  ...
  TextStyle get text1Color {
    return copyWith(color: ConstColor.text1Color);
  }

  TextStyle get primaryTextColor {
    return copyWith(color: ConstColor.primaryColor);
  }
  ...
  TextStyle get subTitleTextColor {
    return copyWith(color: ConstColor.subTitleColor);
  }
